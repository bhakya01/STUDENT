...
This challenge focuses on practicing SQL JOINs and built-in functions using a School database. You will work with student, course, and enrollment information and apply SQL functions for numeric, string, and date operations.
Learning Outcomes
